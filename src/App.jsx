...
const EXPERIENCE = [
  {
    ...
    parts: [
      ...
      },
      {
        ...
        chips: ['DJI F450', 'Pixhawk', 'MTF-01 Optical Flow'],
        media: [
          {
            src: '/projects/auav-prototype.jpg', w: 1300, h: 1143,
            alt: 'The F450 prototype quadcopter on a desk with a Pixhawk flight controller mounted on top',
            caption: 'The prototype: a light-show F450 stripped back and rebuilt around a Pixhawk, with the optical flow module tucked underneath.',
          },
          {
      ...
      },
      {
        ...
        points: [
          'Pixhawk 2.4.8 flight controller, with the MTF-01 optical flow module mounted underneath',
        ...
        chips: ['Carbon Fiber Frame', 'Pixhawk 2.4.8', 'Onshape', '3D Printing'],
        media: [
          {
          ...
          },
          {
            ...
            alt: 'The finished carbon fiber quadcopter on a desk with Pixhawk and GPS mounted',
  ...
  },
  {
    ...
    tag: 'Engineering',
    description: "I supported CHEP's Perfect Plant initiative, a global rollout of upgraded Factory Management Systems across 750+ manufacturing sites. My job was pre-migration verification: capturing the exact working state of every system at a plant before the change, so afterward anyone could prove whether the migration broke something or whether it was already broken. I worked through roughly 25 sites a week, remotely baselining every layer from Allen-Bradley PLCs and HMIs down to the inspection units and the SQL databases underneath. I wrote the verification runbook myself and built a Python script integrated with Power Automate that cut audit setup time by about 15%. It is the first role where I have worked directly with the systems that actually run factory floors.",
  },
  {
